...
<dt><a href="#toHex">toHex(value, [default_value])</a> ⇒ <code>string</code></dt>
<dd><p>convert Buffer or Array[int] to hex</p>
</dd>
...
<dd><p>Convert object to array, used for params like {string|string[]}</p>
</dd>
...
<dd><p>Returns a nice formatted error message - wrapper for format()</p>
</dd>
<dt><a href="#toHtml">toHtml(value)</a> ⇒ <code>string</code></dt>
<dd><p>Return string for inject in html</p>
</dd>
<dt><a href="#roundFload">roundFload(value, digits)</a> ⇒ <code>number</code></dt>
<dd><p>True round</p>
</dd>
...
<dd><p>Replace substrings in string like format in c#</p>
</dd>
<dt><a href="#formatExt">formatExt(string_for_format, [replaces], [left], [right])</a> ⇒ <code>string</code></dt>
<dd><p>Replace substrings in string like &quot;format&quot; with specify border characters</p>
</dd>
...
<dd><p>Convert text_page_char result to byte markup for fs.createReadStream(...)</p>
</dd>
...
## toHex(value, [default_value]) ⇒ <code>string</code>
...
| Param | Type |
| --- | --- |
| value | <code>Buffer</code> \| <code>Array.&lt;Number&gt;</code> | 
| [default_value] | <code>Buffer</code> | 
...
## roundFload(value, digits) ⇒ <code>number</code>
True round
